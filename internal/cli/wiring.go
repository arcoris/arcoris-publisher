...
type Application interface {
	...
	PrepareTargets(ctx context.Context, req app.Request) (app.Result, error)
	...
	DiagnoseTransactions(ctx context.Context, req app.TransactionRequest) (app.TransactionDiagnosticsResult, error)
}
